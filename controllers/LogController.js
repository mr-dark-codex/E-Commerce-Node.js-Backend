...
export class LogController {
  ...
  getLogs = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, result, 'Logs retrieved successfully'));
  });
  ...
  getLogStats = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, stats, 'Log statistics retrieved successfully'));
  });
  ...
  cleanOldLogs = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, result, 'Old logs cleaned successfully'));
  });
  ...
  archiveLogs = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, {}, 'Log files archived successfully'));
  });
}